...
const MENU_COMMANDS = [
  { title: 'Sugar Purchase Entry (New Voucher)', route: '/voucher/purchase', shortcut: 'P', category: 'Voucher' },
  { title: 'Dispatch Entry (Sales & Deliveries)', route: '/voucher/dispatch', shortcut: 'D', category: 'Voucher' },
  { title: 'Purchase Payment (Supplier Payment)', route: '/voucher/payment', shortcut: 'Y', category: 'Voucher' },
  { title: 'Broker Party Payment (Customer Receipt)', route: '/voucher/receipt', shortcut: 'R', category: 'Voucher' },
  { title: 'Contra / Bank Transfer', route: '/voucher/contra', shortcut: 'T', category: 'Voucher' },
  ...
  { title: 'Suppliers & Sugar Mills Register (List)', route: '/register/supplier', shortcut: 'S', category: 'Register' },
